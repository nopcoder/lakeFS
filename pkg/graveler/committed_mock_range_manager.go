...
func (m *MockValueIterator) SeekGE(id Key) {
	m.ctrl.T.Helper()
...
func (m *MockValueIterator) Value() *Record {
	m.ctrl.T.Helper()
...
func (m *MockRangeManager) Exists(ctx context.Context, ns Namespace, id ID) (bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockRangeManager) GetURI(ctx context.Context, id ID) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockRangeManager) GetValue(ctx context.Context, ns Namespace, id ID, key Key) (*Record, error) {
	m.ctrl.T.Helper()
...
func (m *MockRangeManager) GetValueGE(ctx context.Context, ns Namespace, id ID, key Key) (*Record, error) {
	m.ctrl.T.Helper()
...
func (m *MockRangeManager) GetWriter(ctx context.Context, ns Namespace, metadata Metadata) (RangeWriter, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetWriter", ctx, ns, metadata)
	ret0, _ := ret[0].(RangeWriter)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRangeManager) NewRangeIterator(ctx context.Context, ns Namespace, pid ID) (ValueIterator, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewRangeIterator", ctx, ns, pid)
	ret0, _ := ret[0].(ValueIterator)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Close mocks base method.
func (m *MockRangeWriter) Close() (*WriteResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Close")
	ret0, _ := ret[0].(*WriteResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRangeWriter) ShouldBreakAtKey(key Key, params *Params) bool {
	m.ctrl.T.Helper()
...
func (m *MockRangeWriter) WriteRecord(record Record) error {
	m.ctrl.T.Helper()

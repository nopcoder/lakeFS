...
// When reaching a conflict, the returned Diff will be of type DiffTypeConflict.
...
func (d *compareIterator) baseGE(key Key) (*ValueRecord, *Range, error) {
	d.base.SeekGE(key)
	if !d.base.Next() {
...
func (d *compareIterator) valueFromBase(key Key) (*ValueRecord, error) {
	d.base.SeekGE(key)
	var val *ValueRecord
...
func (d *compareIterator) stepRange() (hasMore bool, done bool) {
	...
	baseValue, baseRange, err := d.baseGE(Key(rng.MinKey))
	if err != nil {
		d.err = err
		return false, true
	}
...
func (d *compareIterator) SeekGE(id Key) {
	d.val = nil
	d.err = nil
	d.diffIt.SeekGE(id)
}

func (d *compareIterator) Value() (*Diff, *RangeDiff) {
	if d.err != nil {
		return nil, nil
	}
	return d.val, d.rng

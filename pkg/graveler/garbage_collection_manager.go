...
func (m *GarbageCollectionManager) GetCommitsCSVLocation(runID string, storageID StorageID, sn StorageNamespace) (string, error) {
...
func (m *GarbageCollectionManager) GetAddressesLocation(storageID StorageID, sn StorageNamespace) (string, error) {
...
func (m *GarbageCollectionManager) GetUncommittedLocation(runID string, storageID StorageID, sn StorageNamespace) (string, error) {
...
func (m *GarbageCollectionManager) SaveGarbageCollectionUncommitted(ctx context.Context, repository *RepositoryRecord, filename, runID string) error {
...
type RepositoryCommitGetter interface {
	List(ctx context.Context) (CommitIterator, error)
...
func (r *repositoryCommitGetter) List(ctx context.Context) (CommitIterator, error) {
	return r.refManager.ListCommits(ctx, r.repository)
}

func (r *repositoryCommitGetter) Get(ctx context.Context, id CommitID) (*Commit, error) {
	return r.refManager.GetCommit(ctx, r.repository, id)
}

func NewGarbageCollectionManager(blockAdapter block.Adapter, refManager RefManager, committedBlockStoragePrefix string) *GarbageCollectionManager {
...
func (m *GarbageCollectionManager) GetRules(ctx context.Context, storageID StorageID, storageNamespace StorageNamespace) (*GarbageCollectionRules, error) {
...
func (m *GarbageCollectionManager) SaveRules(ctx context.Context, storageID StorageID, storageNamespace StorageNamespace, rules *GarbageCollectionRules) error {
...
func (m *GarbageCollectionManager) SaveGarbageCollectionCommits(ctx context.Context, repository *RepositoryRecord, rules *GarbageCollectionRules) (string, error) {
